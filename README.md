<div align="center">
  <br />
    <a href="" target="_blank">
      <img src="./public/assets/images/VitalCare.jpg" alt="Project Banner">
    </a>
  <br />
...
**Here is a working live demo : https://vitalcare-delta.vercel.app/**
...
```bash
git clone https://github.com/AymenGabsi/vitalcare.git
cd vitalcare
```
...
Open [http://localhost:3005](http://localhost:3005) in your browser to view the project.
